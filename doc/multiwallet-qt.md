...
In order to support loading of multiple wallets in feirm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is feirm.cpp.
...
Changes to feirm.cpp
----------------------
feirm.cpp is the entry point into feirm-qt, and as such, will require some minor modifications to provide hooks for
