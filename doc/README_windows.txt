...
Intro
-----
Feirm (FRM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Feirm utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run feirm-qt.exe.

Feirm Core is the original Feirm client and it builds the backbone of the network.
However, it downloads and stores the entire history of Feirm transactions;
