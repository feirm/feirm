...
// Copyright (c) 2017 The Feirm Core developers
 ...
 * Feirm system. There are three: the main network on which people trade goods
...
public:
    ...
    int LAST_BLOCK() const { return nLastBlock; }
