...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Feirm features */
        {"feirm", "masternode", &masternode, true, true, false},
        {"feirm", "listmasternodes", &listmasternodes, true, true, false},
        {"feirm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"feirm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"feirm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"feirm", "masternodedebug", &masternodedebug, true, true, false},
        {"feirm", "startmasternode", &startmasternode, true, true, false},
        {"feirm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"feirm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"feirm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"feirm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"feirm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"feirm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"feirm", "mnbudget", &mnbudget, true, true, false},
        {"feirm", "preparebudget", &preparebudget, true, true, false},
        {"feirm", "submitbudget", &submitbudget, true, true, false},
        {"feirm", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"feirm", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"feirm", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"feirm", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"feirm", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"feirm", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"feirm", "mnfinalbudget", &mnfinalbudget, true, true, false},
...
{
    return "> feirm-cli " + methodname + " " + args + "\n";
}
