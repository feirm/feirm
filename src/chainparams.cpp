...
// Copyright (c) 2017 The Feirm developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (857742, uint256("0xc41ef34e10c181aa2d7dabaef68ca765dc43bab0af437c4fd6d412b1af748548"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1616772080, // * UNIX timestamp of last checkpoint block
    1744704,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        // Feirm private keys start with '7'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 55);
        // Feirm BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Feirm BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Feirm BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        // Testnet Feirm script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Feirm BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Feirm BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Feirm BIP44 coin type is '1' (All coin's testnet default)
