                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Feirm Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XFE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and feirm: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Feirm Core"), this);
    aboutAction->setStatusTip(tr("Show information about Feirm Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Feirm"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XFE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XFE addresses"));
    ...
    openAction->setStatusTip(tr("Open a feirm: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Feirm Core help message to get a list with possible Feirm command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Feirm Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Feirm network", "", count));
}
...
{
    QString strTitle = tr("Feirm Core"); // default title
