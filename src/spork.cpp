...
// XFE: on startup load spork values from previous session if they exist in the sporkDB
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_20_NEW_PROTOCOL_ENFORCEMENT_4") return SPORK_20_NEW_PROTOCOL_ENFORCEMENT_6;
