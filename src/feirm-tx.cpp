...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Feirm Core feirm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  feirm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Feirm transaction") + "\n" +
                               "  feirm-tx [options] -create [commands]   " + _("Create hex-encoded Feirm transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Feirm transaction
