...
#   c) node1 mines 32 blocks, so now node 0 has 500000FRM, node 1 has 4250FRM, node2 has none.
#   d) node0 sends 601 FRM to node2, in two transactions (301 FRM, then 300 FRM).
