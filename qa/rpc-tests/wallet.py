...
#   c) node1 mines 32 blocks, so now node 0 has 500000XFE, node 1 has 4250XFE, node2 has none.
#   d) node0 sends 601 XFE to node2, in two transactions (301 XFE, then 300 XFE).
