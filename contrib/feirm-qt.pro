...
RESOURCES += src/qt/feirm.qrc src/qt/feirm_locale.qrc

TRANSLATIONS += src/qt/locale/feirm_bg.ts \
                src/qt/locale/feirm_de.ts \
                src/qt/locale/feirm_en.ts \
                src/qt/locale/feirm_es.ts \
                src/qt/locale/feirm_fi.ts \
                src/qt/locale/feirm_fr.ts \
                src/qt/locale/feirm_it.ts \
                src/qt/locale/feirm_ja.ts \
                src/qt/locale/feirm_pl.ts \
                src/qt/locale/feirm_pt.ts \
                src/qt/locale/feirm_ru.ts \
                src/qt/locale/feirm_sk.ts \
                src/qt/locale/feirm_sv.ts \
                src/qt/locale/feirm_vi.ts \
                src/qt/locale/feirm_zh_CN.ts \
                src/qt/locale/feirm_zh_TW.ts
