Contributing to Feirm Core
==================================

The Feirm Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Feirm Core project, and is not to be
confused with overall Feirm Network Protocol consensus changes.

Whether a pull request is merged into Feirm Core rests with the project merge
...
Patches that change Feirm consensus rules are considerably more involved than
...
Where a patch set proposes to change the Feirm consensus, it must have been
...
The project leader is the release manager for each Feirm Core release.
